  ...
  namespace :extensions do
    namespace :mailer_logger do
      ...
      task :update => :environment do
        ...
        puts "Copying assets from MailerLoggerExtension"
        ...
        unless MailerLoggerExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from MailerLoggerExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join MailerLoggerExtension.root, %w(lib tasks *.rake)].each do |file|
      ...
      task :sync => :environment do
        ...
        language_root = MailerLoggerExtension.root + "/config/locales"
